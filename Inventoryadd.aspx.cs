    ...
    public partial class Inventoryadd : System.Web.UI.Page
    {
        ...
        protected void btnAddItem_Click(object sender, EventArgs e)
        {
            if (Request.HttpMethod == "POST")
            {
                ...
                cmd.CommandText = "INSERT INTO iteminventory(ItemId, Name, Price, Quantity) VALUES( '" + Idpr.Value.ToString() + "', '" + itnam.Value.ToString() + "', '" + itprc.Value.ToString() + "', '" + itqty.Value.ToString() + "')";
                cmd.Connection = Konn;
                Konn.Open();
                cmd.ExecuteNonQuery();
                Konn.Close();
